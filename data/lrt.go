...
var AllLRTs = []LRT{
	...
	// 1: TT - Total Terraforming
	{
		...
		Desc:                     "Allows you to terraform by investing solely in Biotechnology. You may terraform a variable up to 30%. Terraforming costs 30% less.",
		PointCost:                -25,
	...
	// 2: ARM - Advanced Remote Mining
	{
		...
		Desc:                       "Gives you three additional mining hulls and two new robots. You will start the game with two Midget-Miners. Don't pick 'Only Basic Remote Mining' with this option.",
		PointCost:                  -159,
	...
	// 4: GR - Generalized Research
	{
		...
		Desc:                   "Your race takes a holistic approach to research. Only half of the resources dedicated to research will be applied to the current field of research; however, 15% of the total will be applied to all other fields.",
		PointCost:              40,
	...
	// 5: UR - Ultimate Recycling
	{
		...
		Desc:                     "When you scrap a fleet at a starbase, you recover 90% of the minerals and some of the resources. The resources are available for use the next year. Scrapping at a planet gives you half the starbase amount.",
		PointCost:                -240,
	...
	// 6: MA - Mineral Alchemy
	{
		...
		Desc:                      "Allows you to turn resources into minerals four times more efficiently than other races. This may be performed at any planet you own.",
		PointCost:                 -155,
	...
	// 7: NRSE - No Ram Scoop Engines
	{
		...
		Desc:                "No engines which travel at Warp 5 or greater burning no fuel will be available. However, the Interspace-10 engine will be available. This drive travels at Warp 10 without taking damage.",
		PointCost:           160,
	...
	// 8: CE - Cheap Engines
	{
		...
		Code:                   "CE",
		Name:                   "Cheap Engines",
		Desc:                   "You can throw engines together at half cost; however, at speeds in excess of Warp 6, there is a 10% chance the engines won't engage. You start with Propulsion one level higher than you would otherwise.",
		PointCost:              240,
		CheapEngines:           true,
	...
	// 9: OBRM - Only Basic Remote Mining
	{
		...
		Desc:               "The only mining ship available to you will be the Mini-Miner. This trait overrides 'Advanced Remote Mining'. Your maximum population per planet is increased by 10%.",
		PointCost:          255,
	...
	// 10: NAS - No Advanced Scanners
	{
		...
		Desc:                         "No planet penetrating scanners will be available to you. However, conventional scanners will have their range doubled. AR intrinsic scanner is multiplied by √2.",
		PointCost:                    325,
	...
	// 11: LSP - Low Starting Population
	{
		...
		Desc:                       "You will start with 30% fewer colonists.",
		PointCost:                  180,
	...
	// 12: BET - Bleeding Edge Technology
	{
		...
		Desc:                      "New techs initially cost twice as much to build. As soon as you exceed all of the tech requirements by one level, the cost drops back to normal. Miniaturization occurs at 5% a level and pegs at 80%.",
		PointCost:                 70,
	...
	// 13: RS - Regenerating Shields
	{
		...
		Desc:                     "All shields are 40% stronger than the listed rating. Shields regenerate 10% of maximum strength after every round of battle. However, your armor will only be 50% of its rated strength.",
		PointCost:                30,
